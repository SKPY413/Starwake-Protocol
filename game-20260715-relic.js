...
(() => {
    ...
    const RELIC_DEFINITIONS = Object.freeze({
        relic_green_01: { system: "green", name: "VERDANT CORE", hint: "A patient orbit waits beneath the hull.", thresholds: [5, 10, 15] },
        relic_red_01: { system: "red", name: "ASTRAL LENS", hint: "Light compressed beyond conventional limits.", thresholds: [5, 10, 15] },
        relic_blue_01: { system: "blue", name: "GRAVITY HEART", hint: "Space folds, then remembers its shape.", thresholds: [5, 10, 15] },
        relic_purple_01: { system: "purple", name: "ECHOING SWARM", hint: "Small voices answer from outside the signal.", thresholds: [5, 10, 15] },
    });
    ...
    function renderRelicResearchChoices() {
        ...
        panel.innerHTML = Object.entries(RELIC_DEFINITIONS).map(([id, def]) => {
            ...
            return `<button type="button" class="wave-research-choice relic-research-choice system-${def.system}${selected ? " selected" : ""}" data-relic-research="${id}" ${waveResearch.claimed ? "disabled" : ""}>
