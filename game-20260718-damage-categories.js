...
(() => {
    ...
    function getEnemyMutationPool(type, generation) {
        ...
        if (generation >= 2 && ["runner", "brute", "tank", "miniTank"].includes(type)) pool.push("bomb");
    ...
    function createEnemyBullet(enemy, angle) {
        ...
        enemyBullets.push({
            ...
            damage: isGigaBoss ? 28 : isBoss ? 18 : isCarrier ? Math.round(13 * getDifficulty().enemyDamage) : isMiniTank ? 14 : Math.max(7, Math.round((enemy.damage || 12) * 0.62)),
            color: isGigaBoss ? "#ffffff" : isBoss ? "#ff3535" : isCarrier ? "#62d9ff" : isMiniTank ? "#d58bff" : (enemy.generation >= 4 ? "#c68cff" : "#ff79c6"),
        });
    }
